...
(function(w) {
  ...
  let minViewportWidth = 321;
  let maxViewportWidth = 1140;
  ...
  if (window.config.ishViewportRange !== undefined) {
    minViewportWidth = window.config.ishViewportRange.xs[0];
    maxViewportWidth = window.config.ishViewportRange.xl[1];
  }
    ...
    sizeiframe(
      getRandom(
        window.config.ishViewportRange !== undefined
          ? parseInt(window.config.ishViewportRange.s[0], 10)
          : 320,
        window.config.ishViewportRange !== undefined
  ...
  function goXlarge() {
    ...
    sizeiframe(
      getRandom(
        window.config.ishViewportRange !== undefined
          ? parseInt(window.config.ishViewportRange.xl[0], 10)
          : 800,
        maxViewportWidth
      )
    );
  ...
  $('#pl-size-xl').on('click', function(e) {
    e.preventDefault();
    goXlarge();
  });
